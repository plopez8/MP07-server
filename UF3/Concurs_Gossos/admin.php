...
<div class="wrapper medium">
    ...
    <div class="admin">
        ...
        <div class="admin-row">
            <h1> Nou usuari: </h1>
            <form method="post" action="class/crearusuari.php">
                <input type="hidden" name="method" value="nouusuari"/>
                <input type="text" name="nomcrear" placeholder="Nom">
                <input type="password" name="passwordcrear" placeholder="Contrassenya">
